<?php
       ...
       */
       ...
       print("<td width='5%' align='center'>".round($openrow["rate"],2)."</td>");
       
       $p_saled_rs+=round($openrow["amount"],2);
       print("<td width='6%' align='center'>".round($openrow["amount"],2)."</td>");
       ...
       print("<td width='7%' align='center'>".round($cash_sales,2)."</td>");
       ...
       print("<td width='7%' align='center'>".round($tot_cash_sales,2)."</td>");
       
       print("<td width='7%' align='center'>".round($temp_tot_cash_rs,2)."</td>");
       print("</tr>");
       ...
       $d_saled_rs+=round($openrow["amount"],2);
       print("<td width='6%' align='center'>".round($openrow["amount"],2)."</td>");
       ...
       $temp_ch_rs=$ch_sales*$openrow["rate"];
       $d_ch_rs+=$temp_ch_rs;
       print("<td width='5%' align='center'>".round($ch_sales,2)."</td>");
       ...
       print("<td width='5%' align='center'></td>");
       print("<td width='6%' align='center'>".round($pd_saled_rs,2)."</td>");
       ...
       print("<td width='7%' align='center'>".round($pd_tot_cash_rs,2)."</td>");
       print("</tr>");
       ...
       $lo_saled_rs+=round($openrow["amount"],2);
       print("<td width='6%' align='center'>".round($openrow["amount"],2)."</td>");
     ...
     /*  
       ...
       print("<td width='5%' align='center'></td>");
       print("<td width='6%' align='center'>".round($lo_saled_rs,2)."</td>");
       ...
       print("<td width='7%' align='center'>".round($lo_tot_cash_rs,2)."</td>");
       print("</tr>");
       */
       ...
       */
       ...
       $o_tot_sal_rs+=round($openrow["amt"],2);
       print("<td width='5%' align='center'>".round($openrow["amt"],2)."</td>");
       $o_bill_cash_qty+=round($openrow["bcs_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["bcs_qty"],3)."</td>");
       $o_bill_cash_rs+=round($openrow["bcs_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["bcs_rs"],2)."</td>");
       $o_is_qty+=round($openrow["is_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["is_qty"],3)."</td>");
       $o_is_rs+=round($openrow["is_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["is_rs"],2)."</td>");
       
       $o_cs_qty+=round($openrow["cs_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["cs_qty"],3)."</td>");
       $o_cs_rs+=round($openrow["cs_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["cs_rs"],2)."</td>");
       $o_fs_qty+=round($openrow["fs_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["fs_qty"],3)."</td>");
       $o_fs_rs+=round($openrow["fs_rs"],2);
       print("<td width='5%' colspan='2' align='center'>".round($openrow["fs_rs"],2)."</td>");
       $o_xr_qty+=round($openrow["xr_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["xr_qty"],3)."</td>");
       $o_xr_rs+=round($openrow["xr_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["xr_rs"],2)."</td>");
       $o_ef_qty+=round($openrow["ef_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["ef_qty"],3)."</td>");
       $o_ef_rs+=round($openrow["ef_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["ef_rs"],2)."</td>");
       $o_ch_qty+=round($openrow["ch_qty"],3);
       print("<td width='5%' align='center'>".round($openrow["ch_qty"],3)."</td>");
       $o_ch_rs+=round($openrow["ch_rs"],2);
       print("<td width='5%' align='center'>".round($openrow["ch_rs"],2)."</td>");
       ...
       print("<td width='5%' align='center'>".round($o_tot_sal_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_bill_cash_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_bill_cash_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_is_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_is_rs,2)."</td>");
       
       
       print("<td width='5%' align='center'>".round($o_cs_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_cs_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_fs_qty,3)."</td>");
       
       print("<td width='5%' colspan='2' align='center'>".round($o_fs_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_xr_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_xr_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_ef_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_ef_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($o_ch_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($o_ch_rs,2)."</td>");
       ...
       print("<td width='5%' align='center'>".round($pd_saled_rs,2)."</td>");
       
       print("<td width='10%' align='center' colspan='2'>".round($pd_test_ltrs,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_is_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_is_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_cs_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_cs_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_fs_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_fs_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_xr_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_xr_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_ef_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_ef_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_ch_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_ch_rs,2)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_tot_cash_qty,3)."</td>");
       
       print("<td width='5%' align='center'>".round($pd_tot_cash_rs,2)."</td>");
