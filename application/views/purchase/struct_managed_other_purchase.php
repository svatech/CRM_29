...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Other Products Purchase Log</center>
 ...
 <div class='lengthy_form'>
	...
	<input type="button" id="" class='txt2_color' style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:managed_other_purchase_form()"/>
	</div>
	
<div style="float:right;margin:10px;font-weight:bold">
<table>
<tr><td>
<font size="2px" style="margin-left:20px">Search by Voucher No</font>
</td><td>
...
<font size="2px" style="margin-left:20px"> Bill No</font>
</td><td>
