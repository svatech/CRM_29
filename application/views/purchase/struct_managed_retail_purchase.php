...
<center style="margin-bottom:20px;font-size:20pt;color:white;position:inline;">Petrol/Diesel Purchase Log</center>
 ...
 <div class='lengthy_form'>
	...
	<input type="button" id="" class="txt2_color" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:managed_retail_purchase_form()"/>
	</div>
...
<table>
<tr><td>
<font >Search by Voucher No</font>
</td><td>
