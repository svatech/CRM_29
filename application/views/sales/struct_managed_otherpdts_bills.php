...
<div class='lengthy_form'>
	...
	<input type="button" id="" class='txt2_color' style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:managed_other_pdts_bill_form()"/>
	</div>
