...
<div class='lengthy_form'>
 <div style="margin:10px 0px 0px 30px;">	
	...
	<input type="button" id="" class='txt2_color' style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:other_pdts_Editbill_form()"/>
	<p id="cancel_msg" style="float:right;margin-right:40px;display:none;font-size:15px;color:red;">Cancelling...</p>
	</div>
	
<div style="margin-left: 10px;margin-top:10px;margin-bottom:10px;font-weight:bold;font-size:12px;">
<table>
<tr><td >
<p style="font-weight:bold;display:inline;" >Search by Bill No</p>
</td><td>
