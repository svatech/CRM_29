...
<div class='lengthy_form'>
	...
	<input type="button" id="" class="txt2_color" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:PD_Editbill_form()"/>
	<p id="cancel_msg" style="float:right;margin-right:40px;display:none;font-size:15px;color:red;">Cancelling...</p>
	</div>
	
	
<div style="margin-left: 5px;margin-top:10px;margin-bottom:10px;font-weight:bold;font-size:12px;">
<table>
<tr><td >
<p style="display:inline;font-weight:bold;">Search by Bill No</p>
</td>
<td >
<input type="text" class="input" name="billno" id="billno"  style="width:70px;height:18px;" onkeyup="javascript:searchbybillno()" >
</td><td >
<font  style=" font-weight:bold">Indent Number</font>
</td><td >
<input type="text" class="input" name="indent_no" id="indent_no"  style="width:70px;height:18px;" onkeyup="javascript:searchbyindentno()" >
</td><td >
<font style=" font-weight:bold">Customer Name</font>
</td><td >
<input type="text" class="input" name="customer" id="customer"  style="width:70px;height:18px;" onkeyup="javascript:searchbycustomername()" >
</td><td >
