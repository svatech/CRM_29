...
<div class='lengthy_form'>
	...
	<input type="button" id="" class='txt2_color' style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:get_cancelled_bills()"/>
	</div>
	
	
<div style="margin-left: 25px;margin-top:10px;margin-bottom:10px;font-weight:bold;font-size:12px;">
<table><tr><td>
...
<font style="margin-left:40px;font-weight:bold">Customer Name</font>
</td><td>
...
<font style="margin-left:30px;font-weight:bold">Sales Mode</font>
</td><td>
