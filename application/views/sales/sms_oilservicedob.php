...
$oil_service_dob=$row["oil_service_dob"];



$text=urlencode("Dear $cust_name, Due date for changing your vehicle engine oil is on $oil_service_dob. Thank you for being with PRICOL FUEL.");
//ECHO $m."<br>";
