...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="12%" align="right">Sales Mode</td>
		...
		<td width="10%" align="LEFT"><input type='button' value='  Get Report  ' class='txt2_color' onclick="javascript:get_other_bill_register();" style="width:100px;"/> </td>
