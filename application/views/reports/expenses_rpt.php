...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="23%" align="right" style="color:black;font-weight:bold">Expenses From </td>
		...
		<td width="10%" align="LEFT"><input type='button' value='  Get Report  '  class='txt2_color' onclick="javascript:get_expenses_report();" style="width:100px;"/> </td>
