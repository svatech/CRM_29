<?php
       ...
       print("<td width='7%' align='center'>Cash Sales Difference (Ltr)</td>");
       ...
       print("<td width='5%' align='left' colspan='17' style='color:#4c0000;font-weight:bold;'>PETROL/DIESEL SALES</td>");
       ...
       $cash_sales_difference=$tot_cash_sales-$openrow["cash_sales"];
       $p_cash_sales_difference+=round($cash_sales_difference,3);
       if($p_cash_sales_difference < 0) {
       print("<td width='7%' align='center' ><font color='red'>".round($cash_sales_difference,3)." </font></td>");
               }
       else if ($p_cash_sales_difference > 0) {
       print("<td width='7%' align='center' ><font color='red'>".round($cash_sales_difference,3)." </font></td>");
       }
       else {
        print("<td width='7%' align='center'>".round($cash_sales_difference,3)."</td>");
       }
       ...
       $cash_sales_difference=$tot_cash_sales-$openrow["cash_sales"];
       $d_cash_sales_difference+=round($cash_sales_difference,3);
        if ($d_cash_sales_difference > 0){
        print("<td width='7%' align='center'><font color='red'>".round($cash_sales_difference,3)."</font></td>");
        }
        elseif($d_cash_sales_difference < 0){
        print("<td width='7%' align='center'> <font color='red'>".round($cash_sales_difference,3)."</font></td>");
        }
       else{
        print("<td width='7%' align='center'>".round($cash_sales_difference,3)."</td>");
       ...
       $pd_cash_sales_difference=$p_cash_sales_difference+$d_cash_sales_difference;
	   ...
	   print("<td width='7%' align='center'>".round($pd_cash_sales_difference,3)."</td>");   
       ...
       if(!empty($result)){
       print("<tr class='small'>");
       print("<td width='5%' align='left' colspan='2'style='color:#4c0000;font-weight:bold;'>2T LOOSE OIL</td>");
       print("<td width='8%' align='center' colspan='16'></td>");
       print("</tr>");
