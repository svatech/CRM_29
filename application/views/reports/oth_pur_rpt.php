...
<table width="100%" border="0" align="left" cellpadding="2" style="height:40px;">
	<tr class="tab_header_bg">
		...
		<td width="20%" align="right" style="color:black;font-weight:bold">Purchase From </td>
		...
		<td width="20%"><select name='supp_name' id='supp_name' style="width:120px;">
							...
							<option value="<?php echo $pdt["supplier_id"];?>" ><?php echo $pdt["supplier_name"];?></option>
							<?php } ?>
		...
		<td width="10%" align="LEFT"><input type='button' value='  Get Report  ' class='txt2_color' onclick="javascript:other_pur_report()" style="width:100px;"/> </td>
