...
<div class='lengthy_form'>
 <div style="margin:10px 0px 0px 30px;font-weight:bold;">	
	...
	<input type="button" id="" class="txt2_color" style="width:100px;height:20px;margin-left:50px" value="Get Details"  onclick="javascript:get_cancelled_transactions()"/>
...
<input type="text" class="input" name="bank" id="bank" placeholder="Vendor Name" style="width:125px;height:18px;" onkeyup="javascript:searchbybankname()" >
</div>
			<hr width="100%">
