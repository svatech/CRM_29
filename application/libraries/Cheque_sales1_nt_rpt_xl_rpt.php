<?php
class Cheque_sales1_nt_rpt_xl_rpt{
	

 public function Export($data,$data1){
        header("Content-type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=".date('dmY')."_Cheque_Sal1_not_Report.xls");
        print("<tr>");
        print("<p align='center' style='margin-top:10px;color:#006666;font-size:15pt;font-weight:bold;'>Cheque Sales(CHQ not CR in Bank)Report</p>"); 
        print("</tr>");
