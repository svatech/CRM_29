...
class stock_stmt_xl_rpt{
        ...
        print("<tr bgcolor=''>");
        print("<td width='5%' align='center' colspan='13' style='color:#006666'>Stock_statement from ".$sdate." to ".$edate."</td>");
        print("</tr>");
        print("</table>");
      ?>
      <?php if($cat=='all' || $cat=='FUEL'){?>
        <p id="fuels_cati" style="color:#4c0000;font-size:18px;font-weight:bold;display:none;margin:20px 0px 2px 20px;">Fuel Stock  </p>
			...
			<tr bgcolor="#559999" id="hdr_row_1" style='color:white;border-right:1px solid white; '>
...
<p id="oil_cati" style="color:#4c0000;font-size:18px;font-weight:bold;display:none;margin:20px 0px 2px 20px;">Oil Stock </p>
           <table border="1" width="100%" id="oil_heading_table" style="display:none;border-collapse:collapse;">
			<tr bgcolor="#559999" id="hdr_row_2" style='color:white;border-right:1px solid white; '>
			<td align="center" width="20%" >Product</td>
			<td align="center" width="10%" >Opening Stock</td>
			...
			<tr bgcolor="#559999" id="hdr_row_3" style='color:white;border-right:1px solid white;'>
			<td align="center" width="20%" >Product</td>
			<td align="center" width="10%" >Opening Stock</td>
			<td align="center" width="10%" >Purchase Quantity</td>
			<td align="center" width="12%" >Purchase Value</td>
			...
			<tr bgcolor="#559999" id="hdr_row_4" style='color:white;border-right:1px solid white;'>
			<td align="center" width="20%" >Product</td>
			<td align="center" width="10%" >Opening Stock</td>
			<td align="center" width="10%" >Purchase Quantity</td>
			<td align="center" width="12%" >Purchase Value</td>
			...
			<tr bgcolor="#559999" id="hdr_row_5" style='color:white;border-right:1px solid white;'>
			<td align="center" width="20%" >Product</td>
			<td align="center" width="10%" >Opening Stock</td>
			<td align="center" width="10%" >Purchase Quantity</td>
			<td align="center" width="12%" >Purchase Value</td>
