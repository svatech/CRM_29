...
class Bank_transaction_rpt_xl_rpt{
	

 public function Export($data,$data1){
        header("Content-type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=".date('dmY')."_Bank_Transaction_Report.xls");
        print("<tr>");
        print("<p align='center' style='margin-top:10px;color:#006666;font-size:15pt;font-weight:bold;'>Bank Transacion Report</p>"); 
        print("</tr>");
