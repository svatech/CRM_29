...
class Shift_close_xl_rpt{
	   ...
	   print("<tr bgcolor='#559999' id='hdr_row_1' style='color:black;border-right:1px solid white; '>");
       ...
       print("<td width='5%' align='left' colspan='2' style='color:#4c0000;font-weight:bold;'>PETROL/DIESEL SALES</td>");
