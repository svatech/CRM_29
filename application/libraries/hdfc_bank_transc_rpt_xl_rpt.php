<?php
class Hdfc_bank_transc_rpt_xl_rpt{
	

 public function Export($data,$data1,$data2){
        header("Content-type: application/vnd.ms-excel");
        header("Content-Disposition: attachment; filename=".date('dmY')."_Hdfc_bank_transaction_Report.xls");
        print("<tr>");
        print("<p align='center' style='margin-top:10px;color:#006666;font-size:15pt;font-weight:bold;'>HDFC Credit Card Bank Transaction Report</p>"); 
        print("</tr>");
 	   ...
 	   print("<td width='5%' align='center'><span class='txt1_color'>Bank CR Date<span></td>");
       ...
       print("<td width='10%' align='center'><span class='txt1_color'>SAP HDFC Bank Code<span></td>");
